...
void setup() {
  ...
  gift_cofb_aead_encrypt(encryptedData, &sizeOfEncrypted, messageMemory, 10, authMemory, 16, IV, keyMemory);  
  ...
  startTime = micros();
  gift_cofb_aead_decrypt(decryptedData, &sizeOfDecrypted, encryptedData, 26, authMemory, 16, IV, keyMemory);
